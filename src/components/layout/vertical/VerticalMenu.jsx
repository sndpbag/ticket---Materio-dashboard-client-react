    ...
    >
      ...
      >
        ...
        >
          ...
          <MenuItem href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/front-pages/payment`} target='_blank'>
            Payment
          </MenuItem>
          <MenuItem href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/front-pages/checkout`} target='_blank'>
            Checkout
          </MenuItem>
          <MenuItem href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/front-pages/help-center`} target='_blank'>
            Help Center
          </MenuItem>
        </SubMenu>
        <MenuSection label='Apps & Pages'>
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/apps/calendar`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/apps/kanban`}
        ...
        <MenuSection label='Forms & Tables'>
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/forms/form-validation`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/forms/form-wizard`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_PRO_URL}/react-table`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_DOCS_URL}/docs/user-interface/form-elements`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_DOCS_URL}/docs/user-interface/mui-table`}
        ...
        <MenuSection label='Misc'>
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_DOCS_URL}/docs/user-interface/foundation`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_DOCS_URL}/docs/user-interface/components`}
          ...
          <MenuItem
            href={`${import.meta.env.VITE_NEXT_PUBLIC_DOCS_URL}/docs/menu-examples/overview`}
          ...
          <MenuItem
            href={`https://github.com/themeselection/${import.meta.env.VITE_NEXT_PUBLIC_REPO_NAME}/issues`}
          ...
          <MenuItem
            href={import.meta.env.VITE_NEXT_PUBLIC_DOCS_URL}
